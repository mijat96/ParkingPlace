...
public class NavigationServerUtils {
    ...
    public static Retrofit retrofit = new Retrofit.Builder()
            .baseUrl(App.getAppContext().getString(R.string.NAVIGATION_SERVICE_BASE_URL))
            .addConverterFactory(GsonConverterFactory.create())
            .client(getUnsafeOkHttpClient())
            .build();


    public static NavigationService navigationService = retrofit.create(NavigationService.class);
}
